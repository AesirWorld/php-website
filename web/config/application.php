...
return array(
	...
	'DefaultLanguage'      => $GLOBALS['defaultLang'] ? $GLOBALS['defaultLang'] : 'es',                  // Specify the default control panel language (see FLUX_ROOT/lang/ directory for available languages.)
